...
'02':{title:'活用 Gemini：製作自己的排課行事曆',tag:'GEMINI / PLANNING',accent:'#e3a62f',lede:'把課程規則變成一個可操作、可維護的個人排課系統。',goals:['把自然語言需求拆成資料欄位','讓 Gemini 協助整理排課規則與衝堂條件','完成自己的排課行事曆原型'],steps:['列出課程、班級、教師、地點與時段','請 Gemini 找出缺少的條件與衝堂風險','建立 Google Sheet 欄位','請 Gemini 產生排課規則與操作說明','用兩組衝堂資料測試'],practice:'建立至少 5 門課、3 種時段、2 個教室與 2 個可能衝堂案例。',output:'排課行事曆原型、欄位表與使用說明',prompts:['請把我的排課需求拆成資料欄位、必要規則、限制條件與待確認問題。','請根據以下課程資料，找出時間、教師、教室與班級衝堂，並提出三種修正方案。不要自行假設未提供的資訊。','請幫我寫一份排課行事曆的使用說明與測試案例，讓另一位老師可以接手。'],source:'Gemini 課程設計示範；實際 Gemini 功能依帳號介面為準'},
