(function () {
  ...
  const promptDescriptions = {
    ...
    N04: "從核對後事件拆故事節拍，再配置成練習室 4-6 頁小繪本。",
    N05: "建立不補想像的角色與場景事實表。",
    ...
    T03: "用適合指定年齡的視覺比喻解釋抽象概念，並標出比喻邊界。",
    ...
    T17: "準備找證據、連關係、做判斷三層討論題與教師追問。",
    T18: "貼到 Studio Audio Overview 自訂欄，生成教師備課預聽。",
    T19: "貼到 Studio 測驗／字卡自訂欄，建立可回查來源的練習。",
    T20: "在分享筆記本前盤點來源、產物、個資、授權與文化風險。",
    C00: "先訪談需求，沒有資料就不替作者假設。",
    C01: "把核准事實包拆成節拍，再由作者核准 4-6 頁安排。",
    C02: "把核准故事與分頁方案填入內容 YAML。",
    C03: "建立角色、場景、畫風與輸出規格 YAML。",
    C04: "建立不可改寫、不可泛化與待真人確認的紅線 YAML。",
    C05: "只為一個繪本頁或漫畫頁建立可檢查的繪圖工單。",
    C06: "把工單與固定規格組成無字繪本／漫畫頁提示詞。",
